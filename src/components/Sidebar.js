        ...
        <div>
          ...
          {isSideBarOpen && (
            <div className=" bg-white  dark:bg-[#2b2c37]    w-full   py-4 rounded-xl">
              ...
              <div className="  dropdown-borad flex flex-col h-[70vh]  gap-4 ">
                <div className="overflow-x-scroll scrollbar-hide max-h-72">
                ...
                <div
                  ...
                  >
                    <img src={boardIcon} className="   filter-white  h-4 " />
                    <p className=" text-lg font-bold  ">Календарь </p>
                  </div>
                ...
                <div
                  ...
                  >
                    <img src={boardIcon} className="   filter-white  h-4 " />
                    <p className=" text-lg font-bold  ">Пользователи</p>
                  </div>
