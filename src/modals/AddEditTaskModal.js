...
import { addTask } from "../redux/boardsApi";
...
function AddEditTaskModal({
  ...
  const onSubmit = (type) => {
    if (type === "add") {
      ...
      console.log(title, description, subtasks, status, newColIndex);
      dispatch(addTask({title, description, subtasks, status, boardId}));
    } else {
      dispatch(
